...
foreach ($years as $year) {
    for ($i = 1; $i <= 12; $i++) {
        ...
        $cache = md5('cache-general-votes-'.$year.'-'.$i);
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Vote Activity</h3>
        </div>

        <canvas id="general-votes" height="360"></canvas>

        <script>
            new window.Chart(document.getElementById('general-votes'), {
                type   : 'line',
                data   : {
